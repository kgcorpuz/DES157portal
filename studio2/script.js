       ...
       switch (thisSpot) {
        ...
        // each section has showing overlay, header, description and image
           case 'suman': theImg.className = 'suman'; 
            ...
            document.querySelector('div p').innerHTML = "Suman is a sticky rice dessert. It is prepared by steaming the glutinous rice and coconut milk mixture in a banana leaf. It has a nice mild flavor. It's often eaten as a side dish!";
           ...
           document.querySelector('div p').innerHTML = "Buko Pandan is a coconut based dessert. There are many different mix-ins of jello, coconut shreds and nata de coco. It's often colored green with padan leaf flavoring.";
           ...
           document.querySelector('div p').innerHTML = "Puto is a steamed rice cake dessert. It is made out of rice flour, coconut milk and sugar. It's steamed for the texture to be nice and chewy.";
           ...
           document.querySelector('div p').innerHTML = "Taho is a silken tofu dessert. It is often served hot with a thick sugar syrup and boba balls. I enjoy eating it on a cold winter day to warm up!";
           ...
           document.querySelector('div p').innerHTML = "Turon is a crunchy dessert that is a banana with jack fruit wrapped in a lumpia wrapper and fried. It is coated in a sweet sugar syrup for the glossy look.";
