(  function() {
   ...
   // const jazz = new Audio("sounds/jazz.mp3");
   ...
   document.getElementById('music').addEventListener('click', function(){
    ...
    form.addEventListener('submit', function(event) {
        ...
        const text2 = `They collected <span style="color:lime">${adj1}</span> fruits and plants that had the sweetest taste and earthiest textures.`
